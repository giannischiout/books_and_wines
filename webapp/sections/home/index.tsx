...
export default function Home() {
  return (
    <div className="relative min-h-screen bw-grid-bg">
      {/* <FloatingDecorations /> */}
      <div className="relative z-10">
        ...
        <section className="relative mx-auto max-w-7xl overflow-visible px-4 pt-16 pb-16 sm:px-6 sm:pt-20 sm:pb-20 lg:px-8 lg:pt-24 lg:pb-24">
          <div className="grid gap-14 overflow-visible lg:grid-cols-2 lg:items-center lg:gap-20">
        ...
        {/* Latest Reads */}
        <section className="bw-section-divider relative mx-auto max-w-7xl px-4 pt-14 pb-16 sm:px-6 sm:pt-20 sm:pb-20">
          <h2 className="font-(family-name:--font-playfair) mb-8 text-xl font-semibold text-[#8b2e2e] sm:mb-10 sm:text-2xl">
            Latest Reads
          </h2>
          <div className="-mx-4 flex gap-6 overflow-x-auto px-4 pb-2 sm:-mx-6 sm:gap-8 sm:px-6 [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#8b2e2e]/20">
        ...
        {/* Now Reading */}
        <section className="bw-section-divider bw-section-divider-thick border-t border-[#8b2e2e]/10 bg-[#f0e8e0]/50">
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24">
            <h2 className="font-(family-name:--font-playfair) mb-12 text-3xl font-semibold tracking-tight text-[#8b2e2e] md:text-4xl">
              Now Reading
            </h2>
        ...
        <section className="bw-section-divider mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28">
          <h2 className="font-(family-name:--font-playfair) mb-12 text-3xl font-semibold tracking-tight text-[#8b2e2e] md:text-4xl">
            Latest Podcast Episode
          </h2>
        ...
        {/* Upcoming Reads */}
        <section className="bw-section-divider border-t border-[#8b2e2e]/15 bg-[#f0e8e0]/50">
